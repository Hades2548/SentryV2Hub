...
-- Key System
local requiredKey = "LACAZETTE"
local discordLink = "https://discord.gg/EsG6nSNUaj"
local success = false
...
confirmButton.Size = UDim2.new(0.35, 0, 0, 35)
...
discordButton.Size = UDim2.new(0.35, 0, 0, 35)
discordButton.Position = UDim2.new(0.55, 0, 0.7, 0)
...
confirmButton.MouseButton1Click:Connect(function()
    if keyInput.Text == requiredKey then
        ...
        statusLabel.Text = "Correct! Loading script..."
        task.wait(1)
        success = true
        screenGui:Destroy()
    else
...
discordButton.MouseButton1Click:Connect(function()
    local clipboard_success = pcall(function()
...
local Window = redzlib:MakeWindow({
    Title = "GROW A GARDEN || SentryV2",
    SubTitle = "https://discord.gg/65c45JEF",
    SaveFolder = "SentryV2 library"
})
...
local Tab1 = Window:MakeTab({"MAIN", "Test"})
local Tab2 = Window:MakeTab({"AUTO FARM ", "Test"})
local Tab3 = Window:MakeTab({"ITEMS", "Test"})
local Tab4 = Window:MakeTab({"GUI", "Test"})
local Tab5 = Window:MakeTab({"PLAYER", "Test"})
local Tab6 = Window:MakeTab({"OTHER", "Test"})
local Tab7 = Window:MakeTab({"DUPE", "Test"})
local Tab8 = Window:MakeTab({"DUPE V2", "Test"})
local Tab9 = Window:MakeTab({"BEE EVENT", "Test"})

Tab1:AddDiscordInvite({
    Name = "SENTRYV2 SCRIPTS",
    Description = "HERE YOU WILL FIND THE BEST SCRIPTS",
    Logo = "rbxassetid://18751483361",
    Invite = "ttps://discord.gg/65c45JEF",
})
